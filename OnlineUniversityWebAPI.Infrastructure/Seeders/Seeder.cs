    ...
    public class Seeder
    {
        ...
        public async Task Seed()
        {
                    ...
                    var students = new List<Student>
            {
                ...
                new Student { FirstName = "Albert", LastName = "Adams", DateOfBirth = new DateTime(2002, 5, 16), Email = "albertadams@mail.com", RoleId = 2, PasswordHash = HashPassword("albertadams@mail.com") },
                new Student { FirstName = "Amber", LastName = "Hebert", DateOfBirth = new DateTime(1999, 12, 1), Email = "amberhebert@mail.com", RoleId = 2, PasswordHash = HashPassword("amberhebert@mail.com") },
                new Student { FirstName = "Aliyah", LastName = "Holmes", DateOfBirth = new DateTime(2000, 12, 3), Email = "aliyahholmes@mail.com", RoleId = 2, PasswordHash = HashPassword("aliyahholmes@mail.com") },
                new Student { FirstName = "Danielle", LastName = "Goodman", DateOfBirth = new DateTime(1995, 12, 11), Email = "daniellegoodman@mail.com", RoleId = 2, PasswordHash = HashPassword("daniellegoodman@mail.com") },
                new Student { FirstName = "Travis", LastName = "Riley", DateOfBirth = new DateTime(1992, 4, 5), Email = "travisriley@mail.com", RoleId = 2, PasswordHash = HashPassword("travisriley@mail.com") },
                new Student { FirstName = "Frazer", LastName = "Mason", DateOfBirth = new DateTime(1992, 6, 8), Email = "frazermason@mail.com", RoleId = 2, PasswordHash = HashPassword("frazermason@mail.com") },
                new Student { FirstName = "Cory", LastName = "Thompson", DateOfBirth = new DateTime(1998, 12, 13), Email = "corythompson@mail.com", RoleId = 2, PasswordHash = HashPassword("corythompson@mail.com") },
                new Student { FirstName = "Sid", LastName = "Hodges", DateOfBirth = new DateTime(1999, 5, 19), Email = "sidhodges@mail.com", RoleId = 2, PasswordHash = HashPassword("sidhodges@mail.com") },
                new Student { FirstName = "Travis", LastName = "Barlow", DateOfBirth = new DateTime(1994, 9, 26), Email = "travisbarlow@mail.com", RoleId = 2, PasswordHash = HashPassword("travisbarlow@mail.com") },
                new Student { FirstName = "Jonas", LastName = "Turner", DateOfBirth = new DateTime(1990, 8, 17), Email = "jonasturner@mail.com", RoleId = 2, PasswordHash = HashPassword("jonasturner@mail.com") },
                new Student { FirstName = "Hamzah", LastName = "Barrera", DateOfBirth = new DateTime(2000, 6, 6), Email = "hamzahbarrera@mail.com", RoleId = 2, PasswordHash = HashPassword("hamzahbarrera@mail.com") },
                new Student { FirstName = "Derek", LastName = "Dean", DateOfBirth = new DateTime(2000, 10, 3), Email = "derekdean@mail.com", RoleId = 2, PasswordHash = HashPassword("derekdean@mail.com") },
                new Student { FirstName = "Alexis", LastName = "Lynn", DateOfBirth = new DateTime(2002, 2, 20), Email = "alexislynn@mail.com", RoleId = 2, PasswordHash = HashPassword("alexislynn@mail.com") },
                new Student { FirstName = "Joel", LastName = "Cohen", DateOfBirth = new DateTime(1996, 3, 23), Email = "joelcohen@mail.com", RoleId = 2, PasswordHash = HashPassword("joelcohen@mail.com") },
                new Student { FirstName = "Sam", LastName = "Guzman", DateOfBirth = new DateTime(1997, 1, 22), Email = "samguzman@mail.com", RoleId = 2, PasswordHash = HashPassword("samguzman@mail.com") },
